...
import { a as nativeHost, i as isNativeApk, n as APK_HREF, o as nativeJson, r as RELEASE, s as nativeRequest, t as AAB_HREF } from "./native-Cuy9Sebh.mjs";
import { n as require_react } from "../_libs/@radix-ui/react-compose-refs+[...].mjs";
import { y as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
import { a as LayoutGrid, c as Cable, i as Radio, o as GripVertical, r as Terminal, s as Gauge, t as Waypoints } from "../_libs/lucide-react.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
import { t as create } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Cpq8Z6qT.js
...
var useApp = create((set, get) => ({
	...
	tick: () => {
		...
		const dt = lastTick ? clamp((now - lastTick) / 1e3, .08, .5) : .2;
		lastTick = now;
		const { sdr, tel, mode } = get();
		if (sdr.paused) return;
		nativeTimer += dt;
		scanTimer += dt;
		if (isNativeApk() && nativeTimer > .35) {
			nativeTimer = 0;
			pullNative(get, set);
			if (scanTimer > 2.5) {
				scanTimer = 0;
		...
		if (get().usb.rx) {
			...
			nextTel.lastEvent = get().usb.listen ? `LISTEN ${sdr.demod} · ${(sdr.centerHz / 1e6).toFixed(3)} MHz` : `USB ${get().usb.kind.toUpperCase()} RX`;
...
function Waterfall({ centerHz, spanHz, floorDbm, ceilDbm, palette, compact = false, onTune }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const paint = () => {
			...
			const row = wctx.createImageData(192, 1);
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Volume" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
								...
								children: [Math.round(sdr.volume * 100), "%"]
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "range",
							min: 0,
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "mb-1 flex justify-between font-mono text-xs text-muted",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Squelch" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "tabular-nums text-foreground",
								children: Math.round(sdr.squelch * 100)
							})]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
							type: "range",
							min: 0,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 text-xs leading-relaxed text-muted",
						children: native ? "SensorHub at GAME rate (~50 Hz). Pixel GNSS stamps this node when the GPSDO is absent. No high-rate sampling. Alpha may poll /telemetry — it is not required." : "On GrapheneOS, grant location. Magnetometer uses the Generic Sensor API when the OS allows it; the APK reads ICM45631 / MMC5616 / ICP20100 natively."
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-3 flex gap-2",
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
			...
			tab === "bridge" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Panel, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mb-3 text-sm leading-relaxed text-muted",
						children: [
							"After install, Claude Code, Gemini CLI, Grok, Kimi, and any shell agent can run ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-mono text-foreground",
								children: "dslv"
							}),
							" inside Termux or proot Debian. Loopback only — the APK is the radio."
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
						label: "Termux",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mt-3 rounded-lg bg-elevated px-3 py-2 font-mono text-xs leading-relaxed text-muted",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { children: "Termux" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "break-all text-foreground",
								children: INSTALL_TERMUX
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "mt-2",
								children: "Debian"
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "break-all text-foreground",
								children: "dslv tools \xA0·\xA0 dslv status --json"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								children: "Install Termux aliases"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "outline",
								disabled: !native,
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "outline",
								onClick: () => {
									navigator.clipboard?.writeText(INSTALL_TERMUX);
								},
								children: "Copy Termux one-liner"
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-3 text-xs leading-relaxed text-muted",
						children: [
							"Termux → Settings → Allow external apps. GrapheneOS will ask for RUN_COMMAND. Aliases: dslv-status, dslv-listen, dslv-mute, dslv-tune, dslv-capture, dslv-sensors, dslv-spectrum. Agents: ",
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-mono",
								children: "dslv tools"
							}),
...
function AppShell() {
	...
	const linkTag = usbListen || sdrAudio ? "LISTEN" : usbRx ? "USB RX" : mode === "live" ? "LIVE" : mode === "standalone" ? "HANDSET" : "SIM";
	(0, import_react.useEffect)(() => {
		hydrate();
		setArmed(true);
	}, [hydrate]);
