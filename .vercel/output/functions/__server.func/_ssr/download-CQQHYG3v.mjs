import { n as APK_HREF, r as RELEASE, t as AAB_HREF } from "./native-CVOnj4sL.mjs";
import { _ as Link, y as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/download-CQQHYG3v.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "RF → Scanner → Scan. Locks KJY81 / KSTY / Sheriff analog, applies demod + span. Listen on the speaker. Alpha optional — Link → Handset if the Pi is dark." }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
						"CLI → Bridge → Copy installer → paste in Termux → Enter. Agents: ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "font-mono text-foreground",
							children: "dslv help"
						}),
